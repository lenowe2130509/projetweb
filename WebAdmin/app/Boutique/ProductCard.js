            ...
            <div className="ratio ratio-16x9"> 
                ...
                <div className="card-body">
                    ...
                    <div className="d-flex justify-content-between">
                        <a href={`Produits/${props.id}`} className="btn btn-primary">Lire la suite</a>
                        <div>
                            <button className="btn btn-secondary me-2">
                                <a className='text-decoration-none text-white' href={`../ModifProduit/${props.id}`}>
                                    <FaEdit /> Modifier
                                </a>
                            </button>
                            <button className="btn btn-danger text-decoration-none">
                                <a className='text-decoration-none text-white' href={`../SuppProduit/${props.id}`}>
                                    <FaTrash /> Supprimer
                                </a>
                            </button>
                        </div>
